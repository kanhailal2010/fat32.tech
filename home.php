                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="slider-content">
                                    <h1 class="title">Everyone is Going Digital</h1>
                                    <p class="text">We will help you to get your offline business to go online. </p>
                                    <ul class="slider-btn rounded-buttons">
                                        <li><a class="main-btn rounded-one" href="#contact">GET STARTED</a></li>
                ...
                <div class="carousel-item">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="slider-content">
                                    <h1 class="title">Reach larger audience</h1>
                                    <p class="text">We will help you to get more audience by using our digital marketing tools. </p>
                                    <ul class="slider-btn rounded-buttons">
                                        <li><a class="main-btn rounded-one" href="#contact">GET STARTED</a></li>
                                        <!-- <li><a class="main-btn rounded-two" href="#">DOWNLOAD</a></li> -->
                                    </ul>
                ...
                <div class="carousel-item">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="slider-content">
                                    <h1 class="title">New Product Launch!!</h1>
                                    <p class="text">We are launcing new products to help you and your business grow exponentially. Stay tuned!!.</p>
                                    <ul class="slider-btn rounded-buttons">
                                        <li><a class="main-btn rounded-one" href="#contact">GET STARTED</a></li>
                                        <!-- <li><a class="main-btn rounded-two" href="#">DOWNLOAD</a></li> -->
                                    </ul>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-7 col-sm-9">
                    <div class="single-features mt-40">
                        ...
                        <div class="features-content">
                            <p class="text">We can help you build your website using frameworks like Wordpress, Shopify or build custom websites built using PHP, React, Angular, Nodejs at affordable rates.</p>
                ...
                <div class="col-lg-4 col-md-7 col-sm-9">
                    <div class="single-features mt-40">
                        ...
                        <div class="features-content">
                            <p class="text">We can help you with reaching your potential customers using our digital marketing techniques.</p>
                            <a class="features-btn" href="#contact">LEARN MORE</a>
                        </div>
                    </div> <!-- single features -->
                </div>
    ...
    <section id="about" class="testimonial-area">
        <div class="container">
            <div class="row justify-content-between">
                <div class="col-xl-12 col-lg-12">
                    <div class="testimonial-left-content mt-45">
                        ...
                        <p class="text">Every project is undertaken with innovation, quality and customer expectations at the forefront of our collective minds. Continuous improvement is embedded within our company culture and we strive to exceed customer expectations in quality and response time.</p>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-contact-info contact-color-2 mt-30 d-flex ">
                            ...
                            <div class="contact-info-content media-body">
                                <p class="text">support@fat32.tech</p>
                            </div>
                        </div> <!-- single contact info -->
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="single-contact-info contact-color-3 mt-30 d-flex ">
                            ...
                            <div class="contact-info-content media-body">
                                <p class="text">+91 8208088785</p>
                                <p class="text">+91 9008654469</p>
                            </div>
                        </div> <!-- single contact info -->
                    </div>
                </div> <!-- row -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="contact-wrapper form-style-two pt-115">
                        ...
                        <form id="contact-form" action="<?php echo SITE_URL?>contact.php" method="post">
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-12">
                                    <div class="form-input light-rounded-buttons mt-30">
                                        ...
                                        <button class="main-btn light-rounded-two float-right submit-btn">Send Message</button>
                                    </div> <!-- form input -->
                                </div>
                            </div> <!-- row -->
                        </form>
