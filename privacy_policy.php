    ...
    <div class="row justify-content-center">
      <div class="col-lg-6 col-md-10">
        <div class="section-title text-center pb-10">
          ...
          <p class="text">Last updated on 20-11-2023 11:03:26</p>
        </div> <!-- row -->
      </div>
    </div> <!-- row -->
    <div class="row">
      <div class="col-lg-12 col-md-12">
        <p>
          This privacy policy (“Policy”) relates to the manner KANHAI LAL MURMU (“we”, “us”, “our”) in
          ...
          KANHAI LAL MURMU may change this Policy periodically and we urge you to check this page for the
          latest version of the Policy in order to keep yourself updated.
        </p>
        <strong>
        ...
        <p>
          We require this data to provide you with the goods or services offered by us including but not limited, for
        ...
        <p>
          ...
          authenticity of the data or information provided by <br/>
          ...
          support@fat32.techIn the event you choose to not provide or later withdraw your consent, we may not be
